...
fun DrawScope.drawMusicLines(lineCount: Int, lineColor: Color, lineSpacing: Float) {
    val startY = com.example.feature_home.ui.TOP_PADDING
    val endY = size.height
    val startX = size.width / com.example.feature_home.ui.START_PADDING_COEFF
    for (i in 0 until lineCount) {
        ...
        drawLine(
            ...
            strokeWidth = com.example.feature_home.ui.STROKE_WIDTH
        )
    }
}
