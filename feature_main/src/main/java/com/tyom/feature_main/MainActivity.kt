...
import com.tyom.data.nativemidi.MidiSpec
...
class MainActivity : ComponentActivity() {
    ...
    private fun showReceivedMessage(message: ByteArray) {
        when ((message[0].toInt() and 0xF0) shr 4) {
            MidiSpec.MIDICODE_NOTEON.toInt() -> Toast.makeText(this,
                "NOTE_ON [ch:" + (message[0].toInt() and 0x0F) +
                        " key:" + message[1] +
                        " vel:" + message[2] + "]", Toast.LENGTH_SHORT).show()


            MidiSpec.MIDICODE_NOTEOFF.toInt() ->  Toast.makeText(this,
