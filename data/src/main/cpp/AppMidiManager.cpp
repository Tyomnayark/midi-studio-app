 ...
 */
void Java_com_tyom_data_nativemidi_AppMidiManager_startReadingMidi(
    ...
    if (status != AMEDIA_OK) {
        LOGE("Failed to convert Java MidiDevice to native AMidiDevice");
    }
    // Start read thread
    // pthread_init(true);
 ...
 * @param   (unnamed)   TBMidiManager (Java) object.
 */
void Java_com_tyom_data_nativemidi_AppMidiManager_stopReadingMidi(JNIEnv*, jobject) {
 ...
 */
void Java_com_tyom_data_nativemidi_AppMidiManager_startWritingMidi(
        JNIEnv* env, jobject, jobject midiDeviceObj, jint portNumber) {
 ...
 * @param   (unnamed)   TBMidiManager (Java) object.
 */
void Java_com_tyom_data_nativemidi_AppMidiManager_stopWritingMidi(JNIEnv*, jobject) {
 ...
 */
void Java_com_tyom_data_nativemidi_AppMidiManager_writeMidi(JNIEnv* env, jobject,
